...
//        System.out.println("endTime = "+ end);
        ...
        try (PrintWriter writer = new PrintWriter(new File("/Users/ewan/code/beast_and_friends/MultiTypeSpikeModel/src/test/multitypespike/distribution/p0ge_output.csv"))) {
